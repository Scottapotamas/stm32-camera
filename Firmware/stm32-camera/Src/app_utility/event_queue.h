...
struct EventQueue
{
    ...
    StateEvent  *front;       ///< pointer to event at the front of the queue
    StateEvent  **entries;    ///< pointer to event pointer array
};
